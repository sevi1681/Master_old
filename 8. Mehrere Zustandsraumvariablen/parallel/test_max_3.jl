# include("Desktop/GitHub/Master_lokal/8. Mehrere Zustandsraumvariablen/parallel/test_max_3.jl")
...
circ = @circuit begin
    ...
    c2 = capacitor(47e-9), [1] ⟷ j_in[+]    # neue Kapazität (c2 parallel zum Eingang)
...
x_in=range(0, stop=2.0, length=100)
