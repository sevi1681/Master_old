# include("Desktop/GitHub/Master_lokal/8. Mehrere Zustandsraumvariablen/reihe/Gleichstrom_max.jl")
 using ACME
 using Plots

u=[ 1.0 for c in 1:1, n in 1:1000 ]
...
circ = @circuit begin
  ...
  c2 = capacitor(47e-9), [1] ⟷ j_in[+]    # neue Kapazität (c2 in reihe zu r1)
