# include("Desktop/GitHub/Master/3. Umpolung/1_test_min.jl")

using ACME
using Plots

# Hier wird analysiert was passiert wenn man die Spannung 1 mall umpolt 
# Das Umpolen erfolgt nach 4 gleichen Samples von u 
